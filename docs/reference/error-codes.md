...
| `rhino.config.unusable`           | `repo-config.yml` is missing, unreadable, malformed, or inconsistent, such as a declared license path that is absolute or climbs out of the root.                                                                                                            |
