...
- [Docs quality gate](docs-quality-gate.md) — a read-only audit of documents, handing findings to propagation and auditing again until two consecutive audits are clean. Explicit request or release only.
